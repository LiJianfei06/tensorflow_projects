...
#   
        ...
        with tf.Session() as sess:  
            saver.restore(sess,"./logs/model.ckpt-200000")  
            ...
            for root_str in random_name_list:
                ...
                image = 1.0-(image.flatten() *0.00390625)
                print text
                ...
                if (((abs(ord(text[0])-ord(text_pre[0]))==32 and ord(text_pre[0])>48) or (ord(text[0])-ord(text_pre[0])==0)) and
                ((abs(ord(text[1])-ord(text_pre[1]))==32 and ord(text_pre[1])>48)or (ord(text[1])-ord(text_pre[1])==0)) and
                ((abs(ord(text[2])-ord(text_pre[2]))==32 and ord(text_pre[2])>48)or (ord(text[2])-ord(text_pre[2])==0)) and
                ((abs(ord(text[3])-ord(text_pre[3]))==32 and ord(text_pre[3])>48)or (ord(text[3])-ord(text_pre[3])==0)) ):
                    hint="True" 
                    ture_mun+=1
                else:
                    hint="False"
                ...
                print("正确: {}  预测: {} check:{}".format(text[0:4], text_pre,hint))
            print("accuracy:{}".format(ture_mun/(ture_mun+false_mun)))
